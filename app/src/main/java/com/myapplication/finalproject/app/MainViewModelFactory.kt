...
private val saveCharactersInDbUseCase: SaveCharactersInDbUseCase):ViewModelProvider.Factory {

    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        return MainViewModel(getCharactersUseCase = getCharactersUseCase,saveCharactersInDbUseCase = saveCharactersInDbUseCase) as T
    }
}